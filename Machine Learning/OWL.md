...
En el [[no-TFM]], OWL sería la herramienta adecuada para **formalizar el conocimiento simbólico del dominio** (por ejemplo, las relaciones válidas entre objetos de una escena) y **verificar coherencia o inferir nuevas relaciones** cuando se alinea con las predicciones de la red neuronal.
